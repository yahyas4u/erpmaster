...
class ReportController extends Controller
{
    ...
    {	//dd($request);
        ...
        $lims_product_all = Product::select('id', 'name', 'qty', 'is_variant')->where('is_active', true)->where('category_id', $category_id)->get();
		$lims_product_all = Product::select('id', 'name', 'qty', 'is_variant')->where('category_id', $category_id)->get();
        } else {
        ...
        return view('report.product_report',compact('product_id', 'variant_id', 'product_name', 'product_qty', 'start_date', 'end_date', 'lims_warehouse_list', 'warehouse_id','lims_category_all'));
    }
