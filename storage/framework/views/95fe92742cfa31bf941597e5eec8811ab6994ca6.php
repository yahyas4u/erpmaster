                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select required name="customer_id" class="selectpicker form-control" data-live-search="true" id="customer-id" data-live-search-style="begins" title="Select customer...">
												<option value="11">Cash Customer</option>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
											...
											<input type="hidden" name="customer_id_hidden" value="<?php echo e($lims_sale_data->customer_id); ?>" />
											<input type="hidden" name="customer_id" value="<?php echo e($lims_sale_data->customer_id); ?>" />
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/elitebotique/resources/views/sale/edit.blade.php ENDPATH**/ ?>