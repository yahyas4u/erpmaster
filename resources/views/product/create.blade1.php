                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form id="product-form">
                            <div class="row"> 
                            <input type="hidden" name="type" value="standared">
                               <!--  <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            <input type="number" name="qty" class="form-control" step="any" autocomplete="off">
                                        </div>
                                        <span class="validation-msg" id="code-error"></span>
                                    </div>
                                </div> 
                                ...
                                <input type="hidden" name="sale_unit_id" value="">
                                <input type="hidden" name="purchase_unit_id" value="">
                                <!--
