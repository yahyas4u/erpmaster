            ...
            <div class="col-md-6">
                <div class="card">
                    ...
                    <div class="payment-options">
						...
						<div class="column-5">
                            <a  href="" id="register-details-btn" title="{{trans('file.Cash Register Details')}}"><button style="background-color: #b33771;" type="button" class="btn btn-custom" data-toggle="modal">Cash Settlement</button></a>	
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div id="add-return" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" class="modal fade text-left">
            <div role="document" class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        {!! Form::open(['route' => 'sale.find-bill-number', 'method' => 'post', 'files' => false]) !!}
                            <div class="form-group">
